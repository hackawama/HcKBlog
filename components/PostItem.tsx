...
export default function PostItem({ id, title, intention, description, category, createdAt }: PostMetadata) {
    return (
        <Link href={"/" + id} className="block mt-3 w-4/5 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
